    ...
    <>
      ...
      {!token ? (
        <div className="ap-lock">
                  <p className="ap-empty-title">No data</p>
        ...
        <div className="ap-lock">
                  <p className="ap-empty-title">Admin</p>
                      ...
                      {tournaments.map(t => {
                        ...
                        <div key={t.id} className="ap-tourney-item" style={{ flexDirection: 'column', alignItems: 'stretch', gap: 0 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                            <span className="ap-tourney-icon">{t.image || 'T'}</span>
                ...
                <div className="ap-card">
                  ...
                  <form onSubmit={handleMarketplaceSave}>
                    <div className="ap-two-col">
                      ...
                      <div className="ap-field"><label className="ap-label">Category</label><select className="ap-select" value={marketplaceForm.category} onChange={e => setMarketplaceForm(p => ({ ...p, category: e.target.value }))}><option value="typingThemes">Typing Themes</option><option value="utilityPasses">Utility Passes</option></select></div>
